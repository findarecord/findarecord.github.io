...
Search for collections within a given radius of a point
...
`REQUEST`
> GET /v0/search/collections?tags=birth&count=1&radius=1234 HTTP/1.1
> Content-Type: application/json
...
`REQUEST`
> GET /v0/search/collections?tags=birth&count=1&return_repos HTTP/1.1
> Content-Type: application/json
